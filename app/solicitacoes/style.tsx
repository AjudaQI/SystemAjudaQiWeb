// Estilos específicos da tela de Solicitações
// Os estilos principais estão sendo gerenciados via Tailwind CSS e globals.css

export const solicitacoesStyles = {
